...
const ProductCard = ({allData}) => {
  ...
  <div className="group relative mx-auto container  cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
      ...
      <div className="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
        ...
        <button className="rounded-full bg-neutral-900 py-2 px-3.5 font-com text-lg  capitalize text-white shadow shadow-black/60 hover:bg-blue-gray-400 bg-black/60">Buy</button>
      </div>
    </div>
